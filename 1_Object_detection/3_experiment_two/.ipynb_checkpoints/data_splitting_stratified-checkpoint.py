...
# Define paths
src_dir = os.path.join(os.getcwd(), 'datasets/farm_labelled')
...
test_imgs, valid_imgs, test_classes, valid_classes = train_test_split(temp_imgs, temp_classes, stratify=temp_classes, test_size=test_ratio_adjusted, random_state=seed)
